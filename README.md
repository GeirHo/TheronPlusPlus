...
The code uses the features of C++23, and a compliant compiler is required. The library produced by the main make target 'Library' should be linked using the "gold" linker with g++. The standard linker fails to detect all symbols.
